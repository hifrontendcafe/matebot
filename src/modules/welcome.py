...
class Welcome(commands.Cog):
    ...
    async def on_member_join(self, member):
        ...
        \nPor favor, al hacer una consulta dentro del server, intentá incluir la mayor cantidad de datos que puedas sobre qué estás intentando, qué errores te encuentras y qué quieres lograr para que podamos ayudarte de la mejor manera posible. Si tienes dudas de dónde publicar la pregunta puedes consultar en <#594935077637718027> y te orientarán. Asimismo, puedes usar el buscador, situado arriba a la derecha, para verificar que tu pregunta no hay sido respondida anteriormente.
